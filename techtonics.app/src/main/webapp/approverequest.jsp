...
<div id="wrap">
  <div id="header"> <span id="slogan">TechTonics</span>
    <ul>
      <li ><a href="adminhomepage.jsp"><span>Home</span></a></li>
      <li id="current"><a href="approverequest.jsp"><span>Requests</span></a></li>
      <li><a href="newtechtalk.jsp"><span>New Tech Talk</span></a></li>
